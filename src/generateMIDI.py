...
def generate_midi(MIDI_FILENAME, base_note, scale_type, track = 0, channel = 0, time = 0, duration = 1, tempo = 90, volume = 100, chords_flag = False, chords_interval = 2, spook = True):
